-- Table: wavzedemo.product_hist

-- DROP TABLE IF EXISTS wavzedemo.product_hist;
...
/*********************************************************************************************************************************************************************
-- FUNCTION: wavzedemo.update_product_last_modified()

-- DROP FUNCTION IF EXISTS wavzedemo.update_product_last_modified();

CREATE OR REPLACE FUNCTION wavzedemo.update_product_last_modified()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
